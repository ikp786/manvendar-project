...
<script>
        function savebalance()
        {
            ...
            var dataString = 'balance=' + bal;
             $.ajax({
                type: "post",
                url: "<?php echo e(url('admin/purchase-balance')); ?>",
                data: dataString,
				dataType:"json",
    ...
    <div class="panel panel-default">
        <div class="panel-body">
			<div class="">
                <h1 class="page-title" style="color:balack; font-size:20px;"><?php echo e('PURCHASE BALANCE'); ?></h1>
			</div>
        ...
        <div class="">
             <div class="box" style="overflow-y: scroll;max-height: 600px">
				<table id="example2" class="table table-bordered ">
                    ...
                    <tbody>
                    <?php $__currentLoopData = $purchageBalanceReports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<?php $s = $report->created_at;
                        ...
                        <tr>
                            ...
                            <td><?php echo e($report->total_balance); ?></td>   
                        </tr>
