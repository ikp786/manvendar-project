...
<br>
                ...
                <form class="form-horizontal" action="<?php echo e(url('payment-request')); ?>"  method="post" onSubmit="return sendFundRequest()" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            value="<?php echo e(Auth::user()->name); ?> (Rs. <?php echo e(number_format(Auth::user()->balance->user_balance,2)); ?> )">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div id="upperParentDiv">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control" id="uremark" placeholder="remark" name="uremark" maxlength="250"></textarea>
                    ...
                    <div id="companyDiv" style="display:none">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label text-right" for="Remark">Remark:</label>
                            <div class="col-sm-8">
                                <textarea class="form-control" id="cremark" name="cremark" placeholder="Remark" maxlength="250"></textarea>
                            </div>
                        </div>
                    </div>
					<div class="form-group row">
    ...
    <div class="col-sm-6">
	 <?php if(Auth::user()->role_id==5): ?> 
        <a href="<?php echo e(url('payment-request-report')); ?>">Fund Request History</a>
	 <?php endif; ?>
