...
<div style="">	<!---overflow-y: scroll; max-height:650px-->
	<table id="tableTypeThree" class="table table-bordered table-hover">
            ...
            <tbody>
                <?php $__currentLoopData = $dmtTxnReport; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
