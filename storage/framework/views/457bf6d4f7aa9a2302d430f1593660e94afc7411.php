    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="col-lg-6 col-md-6">
                <h3 class="page-title" style="color: black;"><?php echo e('Service Management'); ?></h3>
                ...
                <tbody>
                	<?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                	<tr>
							...
							<td> <textarea class="form-control" rows="2" id="message_<?php echo e($service->id); ?>" onfocusout="update(<?php echo e($service->id); ?>)"><?php echo e($service->message); ?></textarea></td>
	                		<td>
								<?php echo e(Form::select('status_id', ['1' => 'Start', '0' => 'Stop'],  $service->status_id, ['class'=>'form-control','style'=>($service->status_id) ? "border-color:green" : "border-color:red" ,'id'=>'status_id_'.$service->id,'onChange'=>"serviceOnOff($service->id,'status_id','RECHARGE')"])); ?>

								<span id="messagestatus_id_<?php echo e($service->id); ?>"></span>
							</td>
							<!--<td>
								<?php echo e(Form::select('is_online_service', ['1' => 'Online', '0' => 'Offline'],  $service->is_online_service, ['class'=>'form-control','style'=>($service->is_online_service) ? "border-color:green" : "border-color:red" ,'id'=>'is_online_service_'.$service->id,'onChange'=>"serviceOnOff($service->id,'is_online_service','RECHARGE')"])); ?>

													<span id="messageis_online_service_<?php echo e($service->id); ?>"></span>
							</td>  -->
...
<script type="text/javascript">
	...
	$('input[type="checkbox"]').change(function(){
		...
		$.ajax({
			url:"<?php echo e(url('edit-services')); ?>",
			type:'get',
			data:dataString,
		...
		if(confirm('Are your sure want to update the message of Service'))
			{
				...
				$.ajax({
					type: "post",
					url: "<?php echo e(url('update-services')); ?>/"+id,
					dataType:"json",
					  data:dataString,
	...
	function serviceOnOff(apiId,serviceVar,serviceType)
	{
		...
		if(confirm('Are your sure want to update'))
		{
			 ...
			 $.ajax({
				type: "put",
				url: "<?php echo e(url('edit-services')); ?>/"+apiId,
				data: dataString,
				dataType:"json",
				success: function (data) {
