...
<div class="row">                      
    ...
    <div class="col-1 col-sm-2 col-md-2">
        <a href="<?php echo e(url('recharge-nework')); ?>" data-toggle="tooltip" data-placement="top" title="Ledger Report">
        <span class="info-box-text textheader <?php echo e((Request::is('recharge-nework') && (app('request')->input('searchOf')!='4')) ? 'active' : ''); ?>">Ledger Report</span> 
        </a>
    </div>
    ...
    <div class="col-1 col-sm-2 col-md-2">
        <a href="<?php echo e(url('recharge-nework').'?searchOf=4&product=&mode=&SEARCH=SEARCH'); ?>" data-toggle="tooltip" data-placement="top" title="Refunded">
        <span class="info-box-text textheader <?php echo e((app('request')->input('searchOf')=='4') ? 'active' : ''); ?>">Refunded</span> 
        </a>
    </div>
