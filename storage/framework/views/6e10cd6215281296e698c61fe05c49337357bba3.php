...
<div class="col-lg-12 col-md-12 pull-right">
				...
				<div class="col-lg-6">
                    <?php echo e(Form::open(array('url' => '/updateWalletScheme', 'method' => 'POST','id' => 'commform'))); ?>
					...
					<button type="submit" id="commfor" class="btn btn-success">Save All
						...
						<input type="hidden" id="schemeFor" name="schemeFor" value="<?php echo e($schemeFor); ?>"/>
                </div>
				</div>
            </div>
    ...
    <div class="table table-responsive">
		...
		<td>
		<span style="color:Red"><?php echo e(($value->is_error)?"Error":''); ?></span>
		</td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="frmTasks" name="frmTasks" action="<?php echo e(url('create-impsone-row')); ?>"class="form-horizontal" method="post">
                        <?php echo csrf_field(); ?>
