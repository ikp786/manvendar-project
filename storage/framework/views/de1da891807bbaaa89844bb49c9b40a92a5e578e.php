                                        ...
                                        <table style="width: 100%; border: 1px solid #888;">
                                           ...
                                           <tr></tr>
                                            <tr style="border-top:1px solid #ddd;margin-left:60px" id="trandetailbydmt">
                                                <td>
                                                    <b>Sender Name : <span><?php echo e(@$report->biller_name); ?> </span></b><br />
                                                    <b>Account Number : <span><?php echo e(@$report->beneficiary->account_number); ?></span></b><br/>
                                                    <b>Bank Name : <span><?php echo e(@$report->beneficiary->bank_name); ?></span></b></br>
													<b>IFSC Code : <span><?php echo e(@$report->beneficiary->ifsc); ?></span></b>
                                                </td>
                                                <td>
                                                    <b>Sender Number : <span><?php echo e(@$report->customer_number); ?></span></b><br />
                                                    <b>Beneficiary Name : <span><?php echo e(@$report->beneficiary->name); ?></span></b><br />
