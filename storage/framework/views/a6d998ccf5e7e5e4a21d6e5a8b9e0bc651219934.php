...
$(function () 
{
    $('input[type=radio]').change(function(){
		...
		var dataString = "status="+status+"&field_name="+field_name;
		$.ajaxSetup({
					headers: {
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="user-profile-img">
                                <img width="250" src="<?php echo e(url('/user-uploaded-files')); ?>/<?php echo e(Auth::id()); ?>/<?php echo e(Auth::user()->profile->profile_picture); ?>" alt="<?php echo e(Auth::user()->name); ?>">
                            </div>
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="tabs-framed">
                                ...
                                <ul class="nav nav-pills" >
									...
									<li style="background-color:gainsboro"><a href="#tab-4"  data-toggle="tab">Login Authentication</a></li>
									<li style="background-color:gainsboro"><a href="<?php echo e(url('download-certificate')); ?>">Download Certificate</a></li>
                                        ...
                                        <div class="tab-body" style="background-color: #ecf0f5;">
                                            <dl class="dl-horizontal style-2">
                                              ...
                                              <dt> ID :</dt>
												...
												<dt>Shop Name :</dt>
                                                <dd>
                                                    <?php echo e(Auth::user()->member->company); ?></span>
                                                ...
                                                <dt>Mobile :</dt>
                                                <dd>
                                                    <?php echo e(Auth::user()->mobile); ?></span>
                                                   
                                                </dd>
                                                
                                                <dt>Address :</dt>
                                                <dd>
                                                    <?php echo e(Auth::user()->member->address); ?></span>
                                                   
                                                </dd>
                                                
                                                <dt>Shop Address :</dt>
                                                <dd>
                                                    <?php echo e(Auth::user()->member->office_address); ?></span>
                                                   
                                                </dd>
                                                
                                                <dt>Joining Date :</dt>
                                                <dd>
                                                    <?php echo e(date("d-m-Y", strtotime(Auth::user()->created_at))); ?></span>
                                                </dd>
                                                
                                                <dt>Last Update :</dt>
                                                <dd>
                                                    <?php echo e(date("d-m-Y", strtotime(Auth::user()->updated_at))); ?></span>
