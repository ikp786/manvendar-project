    ...
    function CommissionPage(id){
        ...
        <div class="col-sm-12">
            <div class="col-lg-6 col-md-6">
                <h4 class="page-title" style="color: black;"><?php echo e('Aeps Scheme List'); ?></h4>
					...
					<tbody>
					   <?php $__currentLoopData = $dmtSchemeList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr class="odd gradeX">
                            ...
                            <td><?php echo e(Form::open(array('url' => 'aeps-commission-update'))); ?>
                                ...
                                <?php echo e(Form::submit('View Aeps SCHEME', array('class' => 'btn btn-primary'))); ?>
            ...
            <div class="modal-body">
               ...
               <?php echo Form::open(array('url' =>'#','id'=>'newMoneyScheme')); ?>
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <?php echo e(Form::select('scheme_for', ['7' => 'Aeps'], null, ['class'=>'form-control'])); ?>
