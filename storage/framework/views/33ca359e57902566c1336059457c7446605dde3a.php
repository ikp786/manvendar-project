...
<div class="col-lg-12 col-md-12 pull-right">
				...
				<div class="col-lg-6">
                    <?php echo e(Form::open(array('url' => '/updateAdhaayPayScheme', 'method' => 'POST','id' => 'commform'))); ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="frmTasks" name="frmTasks" action="<?php echo e(url('create-new-adhaar-pay-row')); ?>"class="form-horizontal" method="post">
                        <?php echo csrf_field(); ?>
