    ...
    function CommissionPage(id){
        ...
        <div class="col-sm-12">
            <div class="col-lg-6 col-md-6">
                <h4 class="page-title" style="color: black;"><?php echo e('BILL SCHEME DETAIL'); ?></h4>
   ...
   <div class="panel-body">
    <div class="table table-responsive">
        ...
        <table border='1' class="table table-striped table-bordered table-hover" id="dataTables-example">
					...
					<tbody>
					   <?php $__currentLoopData = $impsSchemeLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr class="odd gradeX">
                            ...
                            <td><?php echo e(Form::open(array('url' => 'bill-pay-commission-update'))); ?>
                                ...
                                <?php echo e(Form::submit('View Bill SCHEME', array('class' => 'btn btn-primary'))); ?>
            ...
            <div class="modal-body">
               ...
               <?php echo Form::open(array('url' =>'#','id'=>'newMoneyScheme')); ?>
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <?php echo e(Form::select('scheme_for', ['5' => 'BILL Payment Scheme'], null, ['class'=>'form-control'])); ?>
