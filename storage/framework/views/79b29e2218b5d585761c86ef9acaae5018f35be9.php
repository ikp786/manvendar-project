    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
           <li>
              <a href="<?php echo e(route('all-transaction-reports')); ?>"><i class="fa fa-circle-o"></i>Network Ledger Report</a>
            </li>
            <li><a href="<?php echo e(route('dmt-reports')); ?>"> <i class="fa fa-circle-o"></i>DMT Reports</a></li>
