...
<script>
        ...
        $.ajax({
            ...
            success: function (msg) {
                ...
                if(msg.status == 18){   alert(msg.message);
                     window.location.href = "<?php echo e(url('reset-again')); ?>";  
                }else if(msg.status == 19)
                {  alert(msg.message);
                    window.location.href = "<?php echo e(url('verify-again')); ?>"; 
                }
	...
	function systemVerificationOtp()
    {
        ...
        $.ajax({
            type: "get",
            url: "<?php echo e(url('login/system-verificaiton')); ?>",
            data: dataString,
            beforeSend: function () 
            {
                $('#displayMessage').html('');
        ...
        <section class="p-loginIWrap">
            <div class="row">
                    ...
                    <div class="col-md-6 formContainer">
                        ...
                        <div class="mlogo">
                            <a href="#">
                                <img src="<?php echo e(url('newlog/images/Logo168.png')); ?>">
                            </a>
                        </div>
                        ...
                        <div class="formICont">
                            <div class="box box-solid">
                                ...
                                <div class="box-body login-box-body">
                                    <div class="padding-20">
                                        ...
                                        <?php endif; ?>
                                        <form method="POST" action="<?php echo e(url('/login')); ?>" accept-charset="utf-8"  autocomplete="off">
                                            <?php echo csrf_field(); ?>
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <div class="input text">
                                               <input id="mobile" type="text" class="form-control" name="mobile" value="<?php echo e(old('mobile')); ?>" maxlength="10" id="mobile" placeholder="Enter Your Mobile Number">
                                        ...
                                        <!--<div class="form-group has-feedback<?php echo e($errors->has('otp') ? ' has-error' : ''); ?>" style="display:none" id="OTP_DIV">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group has-feedback" id="firstTimeLogin" style="display:block">
												...
												<img src="<?php echo e(url('loader/loader.gif')); ?>" id="firstTimeLoginLoader" class="loaderImg" style="display:none;width: 10%;">
												...
												<a class="btn btn-link pull-right" href="<?php echo e(url('newsignup')); ?>">Sign up</a>
                            ...
                            <?php else: ?>
                            <center style="background: whitesmoke;padding: 5%;"><span><b> <p class="welcome" style="font-family: time;font-size: 35px;"> A2z Suvidhaa Pay welcomes <?php echo e(Auth::user()->name); ?> </p>
                            ...
                            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="item active" data-interval="20000">
                                         <img src="<?php echo e(url('newlog/images/IMAG1.JPG')); ?>" style="height:597px">
                                    </div>
                   ...
                   <div class="modal-body">
                    ...
                    <div class="modal-footer">
					 <button type="button" class="btn btn-info waves-effect waves-light" id="systemVerificationBtn" value="add" onclick="systemVerificationOtp()">Verify</button>
						<img src="<?php echo e(url('/loader/loader.gif')); ?>" id="loaderImg" class="loaderImg" style="display:none;width: 10%;">
