    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="col-lg-6 col-md-6">
                <h3 class="page-title" style="color: black;"><?php echo e('A2Z Plus Wallet SCHEME DETAIL'); ?></h3>
					...
					<tbody>
					   <?php $__currentLoopData = $dmtSchemeList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr class="odd gradeX">
                            ...
                            <td><?php echo e(Form::open(array('url' => 'a2z-plus-wallet-commission-update'))); ?>
            ...
            <div class="modal-body">
               ...
               <?php echo Form::open(array('url' =>'#','id'=>'newMoneyScheme')); ?>
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <?php echo e(Form::select('scheme_for', ['4' => 'A2Z Plus Wallet'], null, ['class'=>'form-control'])); ?>
