                                           ...
                                           <tr></tr>
                                            <tr style="border-top:1px solid #ddd;margin-left:60px" id="trandetailbydmt">
                                                <td>
                                                    ...
                                                    <b>Aadhaar Number : <span><?php echo e(@$report->number); ?></span></b><br/>
                                                    <b>Bank Name : <span><?php echo e(@$report->description); ?></span></b></br>
													
                                                </td>
                                                <td>
                                                    <b>Sender Number : <span><?php echo e(@$report->customer_number); ?></span></b><br />
                                                    
                                                    <b>Transaction Type : <span><?php echo e(@$report->txn_type); ?></span></b><br />
                                                </td>
                                                <td></td>
                                            </tr>
											<tr>
                                                ...
                                                <td colspan="3" class="nospace1">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><span id="prt_tranoperator"><?php echo e(@$report->api->api_name); ?></span></td>
