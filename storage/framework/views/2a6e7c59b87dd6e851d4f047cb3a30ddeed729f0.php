...
<div class="col-sm-12">
    ...
    <?php if(in_array(Auth::user()->role_id,array(3))): ?>
...
<div class="row">
            ...
            <table class="table">
                ...
                <?php $__currentLoopData = $bankDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bankDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>   
                    <tr>
                        ...
                        <td><button type="button" class="btn btn-outline-info btn-sm" onclick="updateRecord(<?php echo e($bankDetail->id); ?>)"><i class="fa fa-edit" aria-hidden="true"></i></button>
  ...
  <?php if(in_array(Auth::user()->role_id,array(4))): ?>
