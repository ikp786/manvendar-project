...
.loaderImg {
						...
						for (var key in data) 
						{
							...
							content += '<td> <a onclick="updateRecord('+data[key].user_id+')" href="javascript:void(0)" class="table-action-btn">Update</a><br/>';
								if(data[key].user_role_type == '1'){
									content += '<a href="<?php echo e(url('/admin/member_permission/')); ?>/'+btoa(data[key].user_id)+'" class="table-action-btn" >Permission</a></td>';
								}
							<?php else: ?> 
	...
	function aepsAgentOnBoard(userId)
	{
        ...
        $.ajaxSetup({
             ...
             $.ajax({
                type: "post",
                url: "<?php echo e(url('aeps-onboard')); ?>",
                data: dataString,
                dataType: "JSON",
                beforeSend:function(){
				   ...
				   <?php if(in_array(Auth::user()->role_id,array(3,4,1))): ?>
					  ...
					  <form method="get" action="<?php echo e(Request::url()); ?>" onSubmit="return checkValidation();" class="form-inline">
						...
						<div class="pull-right" style="margin: 0px 5px"> 
							<!-- <a style=" float:right;" href="<?php echo e(url('/admin/member_permission/0')); ?>" class="btn btn-primary">
							   Add Permission
						    </a> -->
					...
					?>
                        ...
                        <tr>
                          ...
                          <td><?php echo e($user->mobile); ?></td>
                           ...
                           <td><?php echo e(@$user->role->role_title); ?>

								<?php if(Auth::user()->role_id==1 && $user->role_id==5): ?>
									<?php if($user->is_aeps_onboard): ?>
										<a class="btn btn-success btn-xs" id="aepsOnboard_<?php echo e($user->id); ?>"><i class="fa fa-check-circle-o" aria-hidden="true"></i></a>
									<?php else: ?>
										<a href="javascript:void(0)" class="btn btn-danger btn-xs" onClick="aepsAgentOnBoard(<?php echo e($user->id); ?>)" id="aepsOnboard_<?php echo e($user->id); ?>"> <i class="fa fa-ban" aria-hidden="true"></i></a>
										<img src="<?php echo e(url('loader/loader.gif')); ?>" id="loaderImg_<?php echo e($user->id); ?>" class='loaderImg' style='display:none'>
                           ...
                           <td><?php echo e(($user->status_id) ? "Active" : "In-active"); ?></td>
                                ...
                                <td><a href="<?php echo e(url('user-recharge-report')); ?>/<?php echo e($user->id); ?>"
                            ...
                            <?php if(Auth::user()->role_id==1): ?>
                                <td>
                                  <a onclick="updateRecord(<?php echo e($user->id); ?>)" href="javascript:void(0)" class="table-action-btn"><i class="md md-edit"></i>Update</a>
								   <?php if(@$user->role->type == 1): ?>
									<a href="<?php echo e(url('/admin/member_permission/')); ?>/<?php echo e(base64_encode($user->id)); ?>" class="table-action-btn">
									    Permission
								    </a>
								    <?php endif; ?>
                                </td>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <select name="paytmScheme" id="paytmScheme" class="form-control select2">
									<?php $__currentLoopData = $walletSchemes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $walletScheme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php if($walletScheme->scheme_for == 4): ?>
										<option value="<?php echo e($walletScheme->id); ?>"><?php echo e(strtoupper($walletScheme->name)); ?></option>
										<?php endif; ?>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <select name="adhaarPayScheme" id="adhaarPayScheme" class="form-control select2">
									<?php $__currentLoopData = $walletSchemes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $walletScheme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php if($walletScheme->scheme_for == 8): ?>
										    <option value="<?php echo e($walletScheme->id); ?>"><?php echo e(strtoupper($walletScheme->name)); ?></option>
										<?php endif; ?>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
