...
<div class="row col-md-12" id="main_data">
    <div class="col-md-4">
         <table class="table">
    		<tbody>       
    			<tr><td style="background-color:lightgreen">Total Success</td><td> <a href="<?php echo e(url('/')); ?>/api-report?fromdate=<?php echo e(date('d-m-Y')); ?>&todate=<?php echo e(date('d-m-Y')); ?>&searchOf=1">[<span id="successTxnCount"> </span>]</a> ₹ <a href="<?php echo e(url('/')); ?>/recharge-nework?fromdate=<?php echo e(date('d-m-Y')); ?>&todate=<?php echo e(date('d-m-Y')); ?>&searchOf=1"><span id="successTxnVolume"><span></a><i class="fa fa-spin fa-refresh" style="color:black" id="successSpiner"></i></td></tr>
    			<tr><td style="background-color:#ff0000">Total Fail</td><td><a href="<?php echo e(url('/')); ?>/api-report?fromdate=<?php echo e(date('d-m-Y')); ?>&todate=<?php echo e(date('d-m-Y')); ?>&searchOf=2">[<span id="failTxnCount"></span>]</a> ₹ <a href="<?php echo e(url('/')); ?>/recharge-nework?fromdate=<?php echo e(date('d-m-Y')); ?>&todate=<?php echo e(date('d-m-Y')); ?>&searchOf=2"><span id="failVolume"><span></a></td></tr>
    			<tr><td style="background-color:#ffff00">Total Pending</td><td><a href="<?php echo e(url('/')); ?>/api-report?fromdate=<?php echo e(date('d-m-Y')); ?>&todate=<?php echo e(date('d-m-Y')); ?>&searchOf=3">[<span id="pendingTxnCount"></span>]</a> ₹ <a href="<?php echo e(url('/')); ?>/recharge-nework?searchOf=3"><span id="pendingVolume"><span></a></td></tr>
    			<tr><td style="background-color:#ff03d4">Total Refunded</td><td><a href="<?php echo e(url('/')); ?>/api-report?fromdate=<?php echo e(date('d-m-Y')); ?>&todate=<?php echo e(date('d-m-Y')); ?>&searchOf=4">[<span id="refundedTxnCount"></span>]</a> ₹ <a href="<?php echo e(url('/')); ?>/recharge-nework?fromdate=<?php echo e(date('d-m-Y')); ?>&todate=<?php echo e(date('d-m-Y')); ?>&searchOf=4"><span id="refundedVolume"><span></a></td></tr>
    			<tr><td></td></tr>
    			...
    			<tr><td style="background-color:pink">Admin Balance</td><td>₹ <?php echo e(number_format(Auth::user()->balance->user_balance,2)); ?></td></tr>
    			  ...
    			  <tr><td style="background-color:#98f598">Retailer Outlet</td><td><a href="<?php echo e(url('admin/retailer')); ?>">[<span style="color:red" id="memberCount_5"></span>] ₹ <span id="availableBalance_5"></span></a></td></tr>
    			   <tr><td style="background-color:#98f598">Api Outlet</td><td><a href="<?php echo e(url('admin/api-member')); ?>"> [<span style="color:red" id="memberCount_7"></span>]₹ <span id="availableBalance_7"></span></a></td></tr>
        ...
        <div class="card bg-c-yellow update-card">
            <div class="card-block">
                <div class="row align-items-end">
                    <div class="col-8">
                        <h4 class="text-white">₹ <?php echo e(number_format($user_master->user_tot_balance,2)); ?> </h4>
    ...
    <div class="div_bal center"> 
        <div class="card bg-c-pink update-card">
            <div class="card-block">
                <div class="row align-items-end">
                    <div class="col-8">
                        <h4 class="text-white">₹ <?php echo e(number_format($user_dist->user_tot_balance,2)); ?> </h4>
    ...
    <div class="div_bal center"> 
        <div class="card bg-c-green update-card">
            <div class="card-block">
                <div class="row align-items-end">
                    <div class="col-8">
                        <h4 class="text-white">₹ <?php echo e(number_format($user_retailer->user_tot_balance,2)); ?></h4>
    ...
    <div class="div_bal center"> 
        <div class="card bg-c-lite-green update-card">
            <div class="card-block">
                <div class="row align-items-end">
                    <div class="col-8">
                        <h4 class="text-white">₹ <?php echo e(number_format($user_admin->user_tot_balance,2)); ?> </h4>
    ...
    <div class="div_bal center"> 
        <div class="card bg-c-green2 update-card">
            <div class="card-block">
                <div class="row align-items-end">
                    <div class="col-8">
                        <h4 class="text-white">₹ <?php echo e(number_format($user_api->user_tot_balance,2)); ?> </h4>
    ...
    <div class="div_bal center"> 
        <div class="card bg-c-pink2 update-card">
            <div class="card-block">
                <div class="row align-items-end">
                    <div class="col-8">
                        <h4 class="text-white">₹ <?php echo e(number_format($total,2)); ?> </h4>
