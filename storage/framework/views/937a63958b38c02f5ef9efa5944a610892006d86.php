...
<div class="wrapper">
  ...
  <?php if(Auth::check()): ?> 
		<?php echo $__env->make('admin.layouts.topo', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		<?php if(in_array(Auth::user()->role_id,array(1,19))): ?>
			<?php echo $__env->make('admin.layouts.topnav', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		<?php elseif(in_array(Auth::user()->role_id,array(3))): ?>
			<?php echo $__env->make('admin.layouts.md-topnav', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?> 
		<?php elseif(in_array(Auth::user()->role_id,array(4))): ?>
		   <?php echo $__env->make('admin.layouts.dist-topnav', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		<?php endif; ?>
  <?php endif; ?>
