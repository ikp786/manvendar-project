    ...
    function CommissionPage(id){
        ...
        <div class="col-sm-12">
            <div class="col-lg-6 col-md-6">
                <h4 class="page-title" style="color: black;"><?php echo e('DMT 1 SCHEME DETAIL'); ?></h4>
					...
					<tbody>
					   <?php $__currentLoopData = $impsSchemeLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr class="odd gradeX">
                            ...
                            <td><?php echo e(Form::open(array('url' => 'imps-commission-update'))); ?>
            ...
            <div class="modal-body">
               ...
               <?php echo Form::open(array('url' =>'#','id'=>'newMoneyScheme')); ?>
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <?php echo e(Form::select('scheme_for', ['1' => 'DMT 1'], null, ['class'=>'form-control'])); ?>
