...
function recharge_pay() {
		...
		function getOffer()
		{
			...
			var dataString = 'provider=' + provider + '&mobile_provider=' + mobile_provider;
			 $.ajax({
                type: "GET",
                url: "<?php echo e(url('getDTHOffer')); ?>",
                data: dataString,
                dataType: 'json',
				beforeSend:function(){
...
function getCustomerInfo()
{
	...
	var dataString = 'consumerNumber=' + consumerNumber+'&providerId=' + provider_id;
			 $.ajax({
                type: "GET",
                url: "<?php echo e(url('get-dth-customer-info')); ?>",
                data: dataString,
                dataType: 'json',
				beforeSend:function(){
        ...
        <div class="modal-body col-md-12 row">
			...
			<div class="col-md-4">					
				...
				<div class="form-group">
				 ...
				 <img src="<?php echo e(url('/loader/loader.gif')); ?>" id="getCustInfoImage" class="loaderImg" style="margin-top: 16px;display:none"/>-->
				...
				<div id="frmTasks" name="frmTasks" class="form-horizontal">
					<table id="tableTypeThree" class="table table-bordered">
						<thead>
						 ...
						 <img src="<?php echo e(url('/loader/loader.gif')); ?>" id="gthImage" class="loaderImg" style="margin-top: 16px;display:none"/>
						<tbody id="offerTBody">
