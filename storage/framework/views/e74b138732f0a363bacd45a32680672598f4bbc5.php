...
function my_varification() {
	...
	$.ajax({
		type: "GET",
		url: "<?php echo e(url('my-wallet-mobile-verification')); ?>",
		data: dataString,
		dataType: "json",
		beforeSend: function () {
...
function my_get_bene()
	{
		   var mobile_number = $("input#number").val();
            if (mobile_number!='') 
			{
                ...
                $.ajax({
                    type: "get",
                    url: "<?php echo e(url('/my-wallet-get-bene-list')); ?>",
                    data: dataString,
                    dataType: "json",
                    beforeSend: function () {
                        $("#verificationBtn").hide();
...
function my_addbene(){
	...
	var dataString = 'mobile_number=' + username + '&beneName=' + bname  + '&accountNumber=' + baccount + '&ifscCode=' + bifsc + '&bankName=' + service_id + '&_token=' + token+'&caseType='+caseType+'&beneficiaryId='+beneficiaryId+'&status='+beneficiaryStatus;
		$.ajax({
		type: "POST",
		url: "<?php echo e(url('my-wallet-bene-add')); ?>",
		data: dataString,
		dataType: "json",
		beforeSend:function(){
			$("addBeneBtn").hide()
...
function my_registration() {
	...
	if (fname != '' && lname != '') 
	{
		var dataString = 'fname=' + fname + '&lname=' + lname +  '&mobile_number=' + $("input#number").val() + '&_token=' + token;
			$.ajax({
			type: "GET",
			url: "<?php echo e(url('my-wallet-remitter-register')); ?>",
			data: dataString,
			dataType: "json",
			beforeSend: function () {
                       // $("#registerBtn").hide();
	...
	function my_otpVerification()
	{
		...
		var dataString = 'mobile=' + number +'&otp='+otp;
		 $.ajaxSetup({
			 ...
			 $.ajax({
                    type: "PUT",
                    url: "<?php echo e(url('my-wallet-mobile-verification-with-otp')); ?>/"+number,
                    data: dataString,
                    dataType: "json",
                    beforeSend: function () {
                        $("#verifyOtpBtn").hide();
	...
	if(confirm("Are you sure want to delete beneficiary"))
	{
		...
		$.ajax({
			type: "put",
			url: "<?php echo e(url('my-wallet-bene-delete-request')); ?>/"+beneId,
			data: dataString,
			dataType:"json",
			success: function (msg) {
				console.log(msg);
...
function Deletebene_confirm(){
	...
	$.ajax({
		type: "put",
		url: "<?php echo e(url('my-wallet-confirm-bene-delete')); ?>",
		data: dataString,
		dataType: "json",
		beforeSend:function(){
...
function preTxnSlip()
{
	...
	if(trans_status=='1'){ 
        	...
        	$.ajax({
        		type: "GET",
        		url: "<?php echo e(url('my-wallet-get-agent-charge-amt')); ?>",
        		data: dataString,
        		dataType: "json",
        		beforeSend:function()
        		{
...
var confirmAmount = $("#confirmAmount").val();
	...
	$.ajax({
		type: "POST",
		url: "<?php echo e(url('my-wallet-paytm-transaction')); ?>",
		data: dataString,
		dataType: "json",
		beforeSend: function () {
...
function checkIsBankDownOrNot()
{
	...
	$.ajax({
		type: "GET",
		url: "<?php echo e(url('my-wallet-check-is-bank-down')); ?>",
		data: dataString,
		dataType: "json",
		beforeSend:function()
		{
...
<div class="text-right">
	<a href="<?php echo e(route('transaction-report')); ?>?product=25&searchOf=3" class="textheader">Pending</a>&nbsp;|&nbsp;
	<a href="<?php echo e(route('transaction-report')); ?>?product=25&searchOf=4" class="textheader">Refunded</a>&nbsp;|&nbsp;
	<a href="<?php echo e(route('transaction-report')); ?>?product=25&searchOf=20" class="textheader">Refund Pending</a>&nbsp;|&nbsp;
	<a href="<?php echo e(route('transaction-report')); ?>?product=25&searchOf=1" class="textheader"> Transaction History</a>&nbsp;&nbsp;
</div>     
                                                            ...
                                                            <td colspan="3" class="nospace1">
                                                                <table class="table table-bordered">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><span id="prt_tranoperator"><?php echo e("A2Z Plus Wallet"); ?></span></td>
