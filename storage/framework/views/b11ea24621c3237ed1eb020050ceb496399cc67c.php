...
<header class="main-header">
    ...
    <a href="#" style="font-size: 25px;color: wheat;font-family: time;">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
			   ...
			   <img src="<?php echo e(url('/user-uploaded-files')); ?>/<?php echo e(Auth::id()); ?>/<?php echo e(Auth::user()->profile->profile_picture); ?>" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              <li class="user-header">
                ...
                <br>
				Last IP:<?php echo e(Auth::user()->last_login_ip); ?><br>
				Last login:<?php echo e(Auth::user()->last_login_at); ?></p>
              </li>
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo e(url('changepassword')); ?>" class="btn btn-default btn-flat">Profile</a>
                  <!--<a href="<?php echo e(url('view-profile')); ?>" class="btn btn-default btn-flat">Profile</a>-->
                </div>
  ...
  <font color="RED" style="font-size: 110%"><marquee direction="left" style="background:white"><b><?php echo e(Auth::user()->company->news); ?></b></marquee></font>
