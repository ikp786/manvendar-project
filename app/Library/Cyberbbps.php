...
use App\Apiresponse;
    class cyberbbps
    {
        ...
        public function balance()
        {
            ...
            $passwd = CP_PASSWORD;
            $serverCert = file_get_contents("client_cecrt.pem");
        ...
        public function CallRecharge($operator, $session_id, $number, $amount, $user_id, $account, $cycle)
        {
            ...
            $sess = substr($sess, -20);
            $querString = "CERT=" . CERT . "\r\nSESSION=$sess\r\nSD=$SD\r\nAP=$AP\r\nOP=$OP\r\nAgentId=BD01BD02MBB000000001\r\nChannel=AGT\r\nfName=vinm\r\nlName=fintech\r\nPanCardNo=NA\r\nAadhar=NA\r\nCardType=NA\r\nEmail=admin@vinm.com\r\nbenMobile=9871623559\r\nGeoCode=28.6139,78.5555\r\nPin=401101\r\nTERMINAL_ID=123123\r\nNUMBER=$number\r\nACCOUNT=\r\nAMOUNT=$amount\r\nAMOUNT_ALL=$amount\r\nTERM_ID=325448\r\nPanCardNo=NA\r\nCOMMENT=Test recharge";
            if (!empty($account)) 
			{
                $querString = "CERT=" . CERT . "\r\nSESSION=$sess\r\nSD=$SD\r\nAP=$AP\r\nOP=$OP\r\nNUMBER=$number\r\nAgentId=LM0514\r\nChannel=AGT\r\nfName=vinm \r\nlName=fintech\r\nPanCardNo=NA\r\nAadhar=NA\r\nCardType=NA\r\nEmail=admin@vinm.com\r\nbenMobile=9871623559\r\nGeoCode=28.6139,78.5555\r\nPin=401101\r\nTERMINAL_ID=123123\r\nACCOUNT=\r\nAMOUNT=$amount\r\nAMOUNT_ALL=$amount\r\nTERM_ID=325448\r\nPanCardNo=NA\r\nCOMMENT=Test recharge";
            }
            ...
            Apiresponse::create(['message' => $response, 'api_type' => 100,'report_id'=>$session_id,'request_message'=>$signInMsg]);
