	...
	public function sendRequest(Request $request)
	{
		...
		else
		{
			...
			$post = array('captureResponse'=>
				...
				'merchantUserName'=>"AEPS76650036991024664",//isset($request->merchantLoginId) ? $request->merchantLoginId : "excelonestopm",
				//'merchantPin'=>md5(1234),
				'merchantPin'=>md5("76650036991024664"),//isset($request->merchantLoginPin) ? md5($request->merchantLoginPin) : md5(1234),
