    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
         <!-- <p>{{Auth::user()->name}}</p>
        <p > Balance:<span id="agentTopBalance">{{number_format(Auth::user()->balance->user_balance,2)}}
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
             ...
             <!-- <li>
                <a href="{{url('changepassword')}}"><i class="fa fa-circle-o"></i>
                  view</a>
              </li>-->
              <li>
                 <a href="{{ url('admin/retailer') }}"><i class="fa fa-circle-o"></i>
                 Create Retailer</a>
              </li>
			   <li><a href="{{ url('member/export') }}"><i class="fa fa-circle-o"></i>Export member</a></li>
             <!-- <li>
                <a href="{{route('accountSetting')}}"><i class="fa fa-circle-o"></i>
                  Account Setting</a>
              </li>-->
          </ul>
        </li>
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li>
              <a href="{{ route('dmt-reports') }}"><i class="fa fa-circle-o"></i>
                Network Usage</a>
            </li>
           
            
            <li>
              <a href="{{ route('dmt-one-report') }}"><i class="fa fa-circle-o"></i>
                A2Zwallet</a>
            </li>
            <li>
              <a href="{{ route('dmt-two-report') }}"><i class="fa fa-circle-o"></i>
                DMT1</a>
            </li>
            <li>
              <a href="{{ route('recharge-reports') }}"><i class="fa fa-circle-o"></i>
                Network Recharge</a>
            </li>
            <li>
              <a href="{{ url('account-statement') }}"><i class="fa fa-circle-o"></i>
                Account Statement</a>
            </li>
          <!-- <li>
              <a href="{{ route('all-transaction-reports')}}"><i class="fa fa-circle-o "></i>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
			  ...
			  <li>
                <a href="{{Route('payment-request-report')}}"><i class="fa fa-circle-o"></i>
			  ...
			  <li>
                <a href="{{ url('fund-request-report') }}"><i class="fa fa-circle-o"></i>Request Report</a>
                <!--<a href="{{ url('retailer-payment') }}"><i class="fa fa-circle-o"></i>Request Report</a>-->
              </li>
          </ul>
        </li>
         <li class="treeview">
          ...
          <ul class="treeview-menu">
              <li><a href="{{Route('network-chain')}}"><i class="fa fa-circle-o"></i>
               Network Chain</a>
              </li>
              <li>
                <a href="{{Route('network-search')}}"><i class="fa fa-circle-o"></i>
                Search Retailer</a>
              </li>
             <!--  <li>
                <a href="{{route('view-network')}}"><i class="fa fa-circle-o"></i>
               View Network</a>
              </li> -->
          </ul>
        </li>
		<li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li>
              <a href="{{route('upper-level-bank-details')}}">
               <i class="fa fa-circle-o"></i>
                MD
              </a>
            </li>
