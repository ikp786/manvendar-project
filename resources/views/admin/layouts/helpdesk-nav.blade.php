            ...
            <ul class="nav navbar-nav"> 
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu" style=" background: #f89923;">
                                ...
                                <li><a href="{{ url('admin/bankupdown') }}">Bank Management</a></li>
			 ...
			 <li class="dropdown">
			  ...
			  <li class="dropdown">
			   ...
			   <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Analytic<span class="caret"></span></a>
                <ul class="dropdown-menu" style=" background: #f89923;">
          
                                <li><a href="{{ url('complain-request-view') }}">Complaint View </a></li>
                </ul>
              </li>
