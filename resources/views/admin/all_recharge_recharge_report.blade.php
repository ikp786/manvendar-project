...
@section('content')
 ...
 <div class="col-sm-12">
            <div class="col-lg-6 col-md-6">
                <h4 class="page-title" style="color: black; ">{{'RECHARGE TRANSACTION REPORT'  }}</h4>
            ...
            <div class="col-md-12">
                    ...
                    <form method="get" action="{{ url('recharge-searchall') }}" class="form-inline" role="form">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <a href="{{url('recharge-transaction-reports')}}"/ class="btn btn-primary  btn-md">Reset
                                    </a>
                ...
                <div class="col-md-6">
                    ...
                    <form method="get" action="{{ url('recharge-searchall') }}" class="form-inline">
				...
				<table id="mytable"  class="table table-bordered " >
					...
					<?php $s = $value->created_at;
                        ...
                        <tr>
                            ...
                            <td>{{ number_format($value->profit,3) }}</td>
