    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="col-lg-6 col-md-6">
                <h3 class="page-title" style="color: black;">{{  'A2Z Plus Wallet SCHEME DETAIL' }}</h3>
					...
					<tbody>
					   @foreach($dmtSchemeList as $key => $value)
						<tr class="odd gradeX">
                            ...
                            <td>{{ Form::open(array('url' => 'a2z-plus-wallet-commission-update')) }}
            ...
            <div class="modal-body">
               ...
               {!! Form::open(array('url' =>'#','id'=>'newMoneyScheme')) !!}
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {{ Form::select('scheme_for', ['4' => 'A2Z Plus Wallet'], null, ['class'=>'form-control']) }}
                        </div>
                    </div>
