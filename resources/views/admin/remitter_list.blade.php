...
<div class="row">
	<div class="col-sm-12">
		<div class="col-lg-6 col-md-6">
			<h3 class="page-title" style="color: black;">{{  'Remitter List' }}</h3>
...
<div class="panel-body">
	...
	<div class="table table-responsive">
		<table border='1' class="table table-striped table-bordered table-hover" id="dataTables-example">
			...
			<tbody>
				@foreach($GetRemitterData as $key => $value)
				<tr class="odd gradeX">
					<td> 
						<input data-id="{{ $value->id }}"  type="checkbox" class="opc1" value="{{ $value->id }}" >
					</td>
					...
					<td>
						<button onclick="updateRecord('{{ $value->id }}')" class="btn btn-info btn-xs">Send</button> 
					</td> 
				</tr>
				@endforeach  
			</tbody>
...
<div class="modal fade" id="addRemitterModel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<!--<form class="cmxform form-horizontal user_form"  enctype="multipart/form-data"  action="{{url('/admin/remitters-send')}}" role="form" method="post">
		    -->
		<form class="form-horizontal cmxform" action="{{url('/admin/remitters-send')}}" role="form" method="post" id="TeamForm" >
