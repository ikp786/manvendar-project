...
@section('content')
    ...
    <div class="container" style="background: white;">
                ...
                <div class="row tab-pane fade in active" id="fundRequest" style="background-color: #fff;margin: 0">
                    ...
                    <form class="form-horizontal" action="{{url('payment-request')}}" method="post" onSubmit="return sendFundRequest()" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" readonly class="form-control-plaintext form-control" id="aproveDetails" value="{{Auth::user()->name }} (Rs. {{ number_format(Auth::user()->balance->user_balance,2)}} )">
                            </div>
                        </div>
                        <div class="form-group row">
        ...
        <div class="col-sm-6 ">
            <a href="{{url('payment-request-report')}}"> Payment Request History</a>
