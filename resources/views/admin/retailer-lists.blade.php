...
.form-control {
    ...
    <div class="row" style="margin-top:100px;">
        <div class="col-sm-12">
            ...
            <h4 class="page-title" style="color: white; font-size: 36px;">{{ $page_title or 'Retailer  Lists' }}</h4>
                ...
                <table id="demo-custom-toolbar" data-toggle="table"
                    ...
                    @foreach($users as $key => $user)
                        ...
                        <tr>
                           ...
                           <td><a href="{{ url('admin/retailer-reports')}}/{{ $user->id}}" class="btn btn-primary btn-sm" role="button" title="Get report of {{ $user->name }}">Reports</a></td>
