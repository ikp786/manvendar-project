    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="col-lg-6 col-md-6">
                <h3 class="page-title" style="color: black;">{{  'Verificatin SCHEME DETAIL' }}</h3>
					...
					<tbody>
					   @foreach($dmtSchemeList as $key => $value)
						<tr class="odd gradeX">
                            ...
                            <td>{{ Form::open(array('url' => 'verification-update')) }}
            ...
            <div class="modal-body">
               ...
               {!! Form::open(array('url' =>'#','id'=>'newMoneyScheme')) !!}
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {{ Form::select('scheme_for', ['6' => 'Verification'], null, ['class'=>'form-control']) }}
                        </div>
                    </div>
