    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="col-lg-6 col-md-6">
                <h4 class="page-title">{{ $page_title or 'Account Statement' }}</h4>
                <ol class="breadcrumb">
                    <li>
                        <a href="{{ url('dashboard') }}">Home</a>
                    </li>
                    <li class="active">
                        {{ $page_title or 'Account Statement' }}
                    </li>
                </ol>
            </div>
        </div>
            ...
            <div class="card-box">
                ...
                <table id="demo-custom-toolbar" data-toggle="table"
                    ...
                    <tr>
                        ...
                        <th data-field="product" data-align="center" data-sortable="true"
                    ...
                    @foreach($reports as $report)
                        <tr>
                            ...
                            @else
                                <td></td>
                            @endif
                            <td>{{ number_format($report->total_balance2,2) }}</td>
