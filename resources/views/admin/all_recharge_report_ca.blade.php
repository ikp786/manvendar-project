...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="col-lg-6 col-md-6">
                <h4 class="page-title" style="color: white; font-size: 36px;">{{ $page_title or ' ALL TXN REPORT(CA)' }}</h4>
            </div>
            <div class="col-lg-6 col-md-6">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                <h4 class="m-t-0 header-title"><b>{{ $page_title or 'All Transaction Report(CA)' }}</b></h4>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-8">
                                <form method="get" action="{{ url('searchall-all-ca') }}">
