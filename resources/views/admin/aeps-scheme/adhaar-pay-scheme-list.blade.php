    ...
    function CommissionPage(id){
        ...
        <div class="col-sm-12">
            <div class="col-lg-6 col-md-6">
                <h4 class="page-title" style="color: black;">{{  'Adhaar Pay Scheme List' }}</h4>
					...
					<tbody>
					   @foreach($dmtSchemeList as $key => $value)
						<tr class="odd gradeX">
                            ...
                            <td>{{ Form::open(array('url' => 'adhaar-pay-commission-update')) }}
                                {{ Form::hidden('schemeName', $value->name) }}
                                {{ Form::hidden('id', $value->id) }}
                                {{ Form::hidden('scheme_for', $value->scheme_for) }}
                                {{ Form::submit('View Adhaar Pay SCHEME', array('class' => 'btn btn-primary')) }}
                                {{ Form::close() }}
                            </td>
            ...
            <div class="modal-body">
               ...
               {!! Form::open(array('url' =>'#','id'=>'newMoneyScheme')) !!}
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {{ Form::select('scheme_for', ['8' => 'Adhaar Pay'], null, ['class'=>'form-control']) }}
                        </div>
                    </div>
