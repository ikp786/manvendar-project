    ...
    <div class="panel-body">
        <form method="get" action="{{ Request::url() }}" class="form-inline" role="form" >
			...
			@if(Auth::user()->role_id == 1) 
				...
				{{ Form::select('product', ['4' => 'DMT1', '5' => 'A2Z wallet', '16' => 'DMT 2','10' => 'AEPS','1' => 'BBPS','13'=>'Suvidhaa','2'=>"INS Verify",'17'=>"A2Z Verify",'14'=>'MROBOTICS'], app('request')->input('product'), ['class'=>'form-control','placeholder'=>'--Select Product--']) }}                         
