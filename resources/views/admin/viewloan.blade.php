            ...
            <div class="card-box">
                <table id="demo-custom-toolbar" data-toggle="table"
                    ...
                    <th data-field="date_time" data-sortable="true">
                        ...
                        <th data-field="kyc" data-sortable="true" data-formatter="dateFormatter">kyc
                        </th>
                        
                        <th data-field="pincode" data-align="center" data-sortable="true"
                            data-sorter="priceSorter">Pincode
                        </th>
                        <th data-field="DOBording" data-align="center" data-sortable="true"
                            data-sorter="priceSorter">DOBording
                        </th>
                        <th data-field="client_3_months" data-sortable="true"
                        >client_3_months
                        </th>
                        <th data-field="succeding_3_month" data-align="center"
                        >succeding_3_monthk
                        </th>
                        ...
                        <th data-field="address" data-sortable="true">address</th>
                            ...
                            <th data-field="email" data-sortable="true">email</th>
                             ...
                             <th data-field="loantype" data-sortable="true">Type/Amount</th>

                             <th data-field="account"data-sortable="true">AccountNo</th>
                            <th data-field="action" data-sortable="true">Action
                            </th>
                     
                    </tr>
                    </thead>
                    <tbody>
                    @foreach($view_loan as $view_loans)
                        <tr>
                            <td>{{ $view_loans->created_at }}</td>
                            <td>{{ $view_loans->id }}</td>
                            <td>{{ $view_loans->first_name }} {{ $view_loans->last_name }}</td>
                            <td>{{ $view_loans->mobile_primary }} {{ $view_loans->mobile_alternet }}</td>
                            <td>{{ $view_loans->kyc }}</td>
                            <td>{{ $view_loans->pincode }}</td>
                            <td>{{  $view_loans->DOBording }}</td>
                            <td>{{ $view_loans->client_3_months }}</td>
                            <td>{{ $view_loans->succeding_3_month }}</td>
                            <td>{{  $view_loans->address }},<br>{{  $view_loans->city }}<br>{{  $view_loans->district }},{{  $view_loans->state }}</td>
                            <td>{{ $view_loans->email }}</td>
                            <td>{{  $view_loans->loan_type }}<br>{{  $view_loans->loan_amount}}</td>
                            <td>{{  $view_loans->saving_account }}</td>
                            <td></td>
