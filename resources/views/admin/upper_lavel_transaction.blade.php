    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="col-lg-6 col-md-6">
                <h4 class="page-title" style="color: white; font-size: 36px;">{{ $page_title or 'ALL RECHARGE REPORT' }}</h4>
            </div>
            <div class="col-lg-6 col-md-6">
                ...
                <table id="demo-custom-toolbar" data-toggle="table"
                    ...
                    @foreach($reports as $key => $value)
                        <tr>
                            ...
                            <td>{{ $value->pay_id }}</td>
                            <td>
                                <a href="{{ url('mobile-recharge-report')}}/{{ $value->user_id }}">{{ $value->user->name }}</a>
                            </td>
                            ...
                            <td>
                                ...
                                {{ number_format($value->total_balance2,2) }}
                                @else
                ...
                <!-- <form id="frmTasks" action="{{ url('report/update') }}" method="post" name="frmTasks"
                    ...
                    <div class="modal-footer"> 
                        <button type="submit" class="btn btn-info waves-effect waves-light" id="btn-save"
                                value="add" onclick="this.disabled=true;refundTranaction()">Save Now
                        </button>
