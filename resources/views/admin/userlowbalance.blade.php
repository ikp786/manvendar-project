            ...
            <div class="card-box">
                ...
                <table id="demo-custom-toolbar" data-toggle="table"
                    ...
                    <tr>
                        ...
                        <th data-field="total_bal" data-align="center" data-sortable="true"
                            data-sorter="priceSorter">Check
                        </th>
                    ...
                    @foreach($reports as $key => $value)
                        <tr>
                            ...
                            <td>{{ ($value->recharge_type == 1) ? number_format($value->total_balance2,2) : number_format($value->total_balance,2) }}</td>
                            <td>@if($previous_b-$value->amount+$value->profit==$value->total_balance)
