...
<div class="text-right">
	<a href="{{route('transaction-report')}}?product=5&searchOf=3" class="textheader">Pending</a>&nbsp;|&nbsp;
	<a href="{{route('transaction-report')}}?product=5&searchOf=4" class="textheader">Refunded</a>&nbsp;|&nbsp;
	<a href="{{route('transaction-report')}}?product=5&searchOf=20" class="textheader">Refund Pending</a>&nbsp;|&nbsp;
	<a href="{{route('transaction-report')}}?product=5&searchOf=1" class="textheader"> Transaction History</a>&nbsp;&nbsp;
</div>     
<div class="row row-sm" autocomplete="off">
          ...
          <div class="col-md-4 mg-t-20" autocomplete="off">
            ...
            <div class="mg-l-10 mg-t-25 pd-t-4">
                <button type="submit" class="btn btn-success" onclick="my_varification()" id="verificationBtn"><i class="fa fa-search"></i></button> <img src="{{url('/loader/loader.gif')}}" id="loaderImg" class="loaderImg" style="display:none"/> 
               ...
               <div class="modal-dialog modal-lg" role="document">
                  ...
                  <div class="modal-content tx-size-sm">
                        <div class="modal-body" style="padding: 10px; border-radius: 0px;">
                            <div class="col-md-12">
                                <button type="button" onclick="my_payment_check()" class="btn" data-dismiss="modal" style="padding: 6px ! important; top: -8px; right: -35px; background-color: rgb(255, 255, 255) ! important; position: absolute;">&times;</button>
                                                            ...
                                                            <td colspan="3" class="nospace1">
                                                                <table class="table table-bordered">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><span id="prt_tranoperator">{{"A2Z Wallet"}}</span></td>
