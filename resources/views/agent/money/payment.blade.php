		...
		<div class="">
			<div class="">
				<div class="">
			     ...
			     <!--  <form action="{{route('money-insurance-payment')}}" method="post" enctype="multipart/form-data">
			        	 {{ csrf_field() }} 
						...
						@include('partials.message_error')
				        	<div class="form-group">
							 ...
							 {{ Form::select('insurancePayments', $insurancePayments, old('insurancePayments'), array('class' => 'form-control','id' => 'name')) }}
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							  <label class="label" style="color:black">Policy Number</label>
				              <input class="form-control" type="text"  name="loan_acc_no"  value="{{old('loan_acc_no')}}" placeholder="loan account number">
							</div>
							
				        	
							<div class="form-group">
							  <label class="label" style="color:black">Premium Amount</label>
