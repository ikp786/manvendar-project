...
<div class="form-inline col-md-12">
	<div class="form-group col-md-3">
		...
		{{ Form::select('state_id', $state_list, 8, array('class' => 'form-control','id' => 'state_id','onChange'=>'getProvider()')) }}	
	</div>
	<div class="form-group col-md-9" id="ImageId">
		@foreach($provider as $prov)
		   <img src="{{url('/')}}/{{$prov->provider_image}}" id="providerId_{{$prov->id}}" class="providerImage" onClick="openRechargeModel({{$prov->id}})" style=" width: 12%;height: 6%;padding-right:9px" name="provider_image" data-toggle="tooltip" data-placement="top" title="{{$prov->provider_name}}">
		 @endforeach
	</div> 
</div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body col-md-12"> 
			<div class="col-md-7">
				...
				{!! Form::open(array('url' =>'bbps','id'=>'myBbpsForm','files'=>true,)) !!}
				<!--<div class="form-group">
				<label class="label" style="color:black">Circle</label>
				{{ Form::select('state_id', $state_list, 7, array('class' => 'form-control','id' => 'state_id','onChange'=>'getProvider()')) }}	
				</div>-->
				<div class="form-group">
				 ...
				 <div class="form-group">
					<label class="label" style="color:black">K Number</label>
					  ...
					  <span style="position: relative;top: -30px;right: 10px;float: right;"><a style="cursor: pointer;" onclick="fetchBillAmount()" id="vbil">View Bill</a><img src="{{url('/loader/loader.gif')}}" id="viewBillLoader" class="loaderImg" style="display:none"/></span>
				...
				<div class="form-group col-md-12" >
				  ...
				  <img src="{{url('/loader/loader.gif')}}" id="billPayLoader" class="loaderImg" style="display:none"/>	 
				</div>
					{!! Form::close() !!}
			</div>	
                                        ...
                                        <table style="width: 100%; border: 1px solid #888;">
                                            <tr>
                                                <th colspan="3">
                                                    <div class="col-md-2 col-sm-2 col-xs-2" style="padding:10px;">
                                                        <img src="{{ asset('newlog/images/Logo168.png') }}" style="width:70px;margin-right: 650px" />
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 col-sm-4 col-xs-4 text-right" style="padding:10px;" id="trandetailbyheadbps">
                                                        <img src="{{asset('newlog/images/bbps_print.png')}}" style="width:170px;">
                                                    </div>
                                                </th>
                                            </tr>
                                            <tr style="border-top:1px solid #ddd;" id="trandetailbybps">
                                                ...
                                                <td>
                                                    ...
                                                    <b>Date & Time : </b><span id="printDate">{{date("d-m-Y H:i:s")}}</span>
        ...
        <tbody>
            ...
            <tr class="odd gradeX" style="background-color:white">
              ...
              @if($recharge_reports->api_id=='27')
                  <td> @if(in_array($recharge_reports->status_id,array(1,3,9,34)))<button id="re_check_{{ $recharge_reports->id}}"  disabled class="btn btn-primary">Check</button> @endif</td>
              @else
                <td> @if(in_array($recharge_reports->status_id,array(1,3,9,34)))<button id="re_check_{{ $recharge_reports->id}}"onclick="this.disabled=true;recharge_status({{ $recharge_reports->id}});" class="btn btn-primary">Check</button> @endif</td>
              @endif
