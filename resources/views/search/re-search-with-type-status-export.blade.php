...
<div class="panel panel-default">
            <div class="panel-body">
                <form method="get" action="{{ Request::url() }}" class="form-inline" role="form" >
					...
					{{ Form::select('searchOf', ['1' => 'Success', '2' => 'Failed','3'=>"Pending",'4'=>"Refunded",'21' => 'Manual Success', '28' => 'Manual Failed'], app('request')->input('searchOf'), ['class'=>'form-control','placeholder'=>'--Select--']) }}
					...
					@if(Auth::user()->role_id == 1)
						...
						{{ Form::select('product', ['2' => 'CyberPlat', '8' => 'RedPay','13'=>'Suvidhaa'], app('request')->input('product'), ['class'=>'form-control','placeholder'=>'--Select--']) }}
