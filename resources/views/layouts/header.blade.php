...
<header class="main-header"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
			   ...
			   <img src="{{url('/user-uploaded-files')}}/{{Auth::id()}}/{{Auth::user()->profile->profile_picture}}" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              <li class="user-header">
                ...
                @endphp  
				 ...
				 Last IP:{{Auth::user()->last_login_ip}}<br> 
              ...
              <li class="user-footer">
                <div class="pull-left">
                  ...
                  <!--<a href="{{ url('view-profile')}}" class="btn btn-default btn-flat">Profile</a>-->
                </div>
  ...
  <font color="RED" style="font-size: 110%"><marquee direction="left" style="background:white"><b>{{Auth::user()->company->news}}</b></marquee></font>
