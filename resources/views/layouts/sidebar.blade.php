 <aside class="main-sidebar">
    ...
    <section class="sidebar">
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            @if(Auth::user()->member->paytm_my_wallet ==1)  
                <li><a href="{{route('my-wallet')}}"><i class="fa fa-circle-o"></i>A2Z Plus Wallet</a></li>
            @endif
      ...
      <i class="fa fa-file"></i>
		...
		@if(Auth::user()->member->adhaar_pay ==1)
		    <li><a href="{{url('aeps-ap')}}"><i class="fa fa-money"></i> Adhaar Pay</a></li>
		@endif
		<li>
