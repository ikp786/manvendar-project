...
<h2>Privacy Policy</h2> <p>
    Excel One Stop Solution private limited built the A2Z Suvidhaa Money app as
    a Commercial app. This SERVICE is provided by
    Excel One Stop Solution private private limited  and is intended for
    use as is.
</p> <p>
    ...
    A2Z Suvidhaa Money unless otherwise defined in this Privacy
    Policy.
</p> <p><strong>Information Collection and Use</strong></p> <p>
    For a better experience, while using our Service,
    we may require you to provide us with certain
    personally identifiable information, including but not limited to Message, Camera, Gallery, Storage, Location and Phone State(device information). The
