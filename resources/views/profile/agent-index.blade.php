                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="user-profile-img">
                                <img width="250" src="{{url('/user-uploaded-files')}}/{{Auth::id()}}/{{Auth::user()->profile->profile_picture}}" alt="{{ Auth::user()->name }}">
                            </div>
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="tabs-framed">
                                ...
                                <ul class="nav nav-pills" >
									...
									<li style="background-color:gainsboro"><a href="{{url('download-certificate')}}">Download Certificate</a></li>
                                        ...
                                        <div class="tab-body" style="background-color: #ecf0f5;">
                                            <dl class="dl-horizontal style-2">
                                              ...
                                              <dt> ID :</dt>
                                                ...
                                                <dt>Address :</dt>
                                                <dd>
                                                    {{ Auth::user()->member->address }}</span>
                                                   
                                                </dd>
                                                
                                                <dt>Shop Address :</dt>
                                                <dd>
                                                    {{ Auth::user()->member->office_address }}</span>
                                                ...
                                                <dt>Last Update :</dt>
                                                <dd>
                                                    {{ date("d-m-Y", strtotime(Auth::user()->updated_at)) }}</span>
