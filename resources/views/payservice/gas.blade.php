                                ...
                                <form method="POST" action="{{ url('/recharge') }}">
                                    ...
                                    <section>
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="mobile_provider" name="provider"><option value="80">GUJARAT GAS COMPANY LTD</option><option value="81">INDRAPRASHTA GAS LTD</option><option value="85">Mahanagar Gas Limited</option></select>
