                                    ...
                                    <div class="col-md-12" id="dvContents">
                                        ...
                                        <table style="width: 100%; border: 1px solid #888;">
                                                ...
                                                <th colspan="2">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-6 text-left" style="padding:10px;">
                                                        <div style="margin-top: -95px; float: left:10px;">
                                                            <b>Shop Name: {{Auth::user()->member->company}}</b>
                                                        </div>
                                                        <br />
                                           ...
                                           <!--  <tr style="border-top:1px solid #ddd;" id="trandetailbybps">
                                                <td>
                                                    <b>Customer Name :{{ @$report->provider->provider_name }} </b><span id="prt_trandbillername"></span><br />
                                                    <b>Customer Mobile No :{{$report->customer_number}} </b><span id="prt_tranbillermobile"></span><br />
                                                    <b>Payment channel :Agent </b><span id="prt_tranchannel"></span><br />
                                                </td>
                                                <td>
                                                    <b>Consumer ID/Number :{{ @$report->number }} </b><span id="prt_trannumber"></span><br />
                                                    <b>Payment Mode : Cash</b><span id="prt_tranpaymode"></span><br />
                                                    <b>Date & Time :{{ \date_format($report->created_at,"d-m-Y H:i:s") }} </b><span id="prt_bdtranddate"></span>
                                                </td>
                                                <td></td>
                                            </tr> -->
                                           <tr></tr>
                                           <tr style="border-top:1px solid #ddd;margin-left:60px" id="trandetailbydmt">
                                                <td>
                                                    ...
                                                    <b>Transaction Type : <span>{{ @$report->api->api_name}}</span></b></br>
                                                      <b>Mobile Number : <span>{{ $report->number}}</span>
                                                      </b></br>
                                                </td>
                                                <td></td>
                                            </tr>
                                                ...
                                                <td colspan="3" class="nospace1">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><span id="prt_tranrefernce">{{$report->ref_id}}</span></td>
