                                           ...
                                           <tr></tr>
                                            <tr style="border-top:1px solid #ddd;margin-left:60px" id="trandetailbydmt">
                                                <td>
                                                    ...
                                                    <b>Aadhaar Number : <span>{{ @$report->number }}</span></b><br/>
                                                    <b>Bank Name : <span>{{ @$report->description}}</span></b></br>
													
                                                </td>
                                                <td>
                                                    <b>Sender Number : <span>{{@$report->customer_number}}</span></b><br />
                                                    
                                                    <b>Transaction Type : <span>{{ @$report->txn_type}}</span></b><br />
                                                </td>
                                                <td></td>
                                            </tr>
											<tr>
                                                ...
                                                <td colspan="3" class="nospace1">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><span id="prt_tranoperator">{{ @$report->api->api_name}}</span></td>
