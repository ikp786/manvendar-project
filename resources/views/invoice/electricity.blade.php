                                        ...
                                        <table style="width: 100%; border: 1px solid #888;">
                                           ...
                                           <tr></tr>
                                            <tr style="border-top:1px solid #ddd;margin-left:60px" id="trandetailbydmt">
                                                <td>
                                                    <b>Biller Name : <span>{{ @$report->biller_name}} </span></b><br />
                                                    <b>Customer Mobile No : <span>{{ @$report->customer_number }}</span></b><br/>
                                                    <b>Payment channel :<span>Agent</span></b></br>
                                                   
                                                </td>
                                                <td>
                                                    <b>Consumer ID/Number : <span>{{@$report->number}}</span></b><br/>
                                                    <b>Payment Mode :<span> Cash</span></b><br/>
                                                    <b>Date & Time : <span>{{ \date_format($report->created_at,"d-m-Y H:i:s") }}</span></b><br/>
                                                </td>
                                                <td></td>
                                            </tr>
                                            <tr>
