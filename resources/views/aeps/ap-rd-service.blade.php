...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<script type="text/javascript">
		...
		<div >
			{!! Form::open(array('url' =>'#','id'=>'myImageForm')) !!}
		<div class="form-group col-md-12 row">
						...
						<div class="form-group col-md-12 row">
                            ...
                            <div class="">
                                {{ Form::select('bankName', $bankLists,null, ['id'=>'bankName','class'=>'form-control ','placeholder'=>'-- Select Bank--']) }}
                            </div>
							</div>
						...
						<div class="form-group col-md-12 row">
							...
							<!-- <input class="btn btn-primary btn-200" onclick="discoverAvdm();" type="button" id="checkDeviceBank" value="Check Your Device">
							 <img src="{{url('loader/loader.gif')}}" id="checkDeviceImage" class="loaderImg" style="display: none;">-->
							 <div id="scanDeviceDiv" style="display:block">
								...
								<img src="{{url('img/newLoader.gif')}}" id="scanDeviceImage" class="loaderImg" style="display: none;">
								<img src="{{url('img/scan_fp.gif')}}" class="" style="display: none;width: 15%;
    border-radius: 15%;" id="captureDeviceLoader" alt="Image">
								<img src="{{url('img/check-circle.gif')}}" class="" style="display: none;" id="captureDeviceSuccessLoader" alt="Image">
							 ...
							 <!--<div id="scanDeviceDiv" style="display:none">
								...
								<img src="{{url('loader/loader.gif')}}" id="scanDeviceImage" class="loaderImg" style="display: none;">
							</div>-->
...
function loadDevicepage()
		{
			if($("#deviceName").val() == "MANTRA")
				window.location.replace("{{url('aeps')}}");
			else
				window.location.replace("{{url('morpho-aeps')}}");
		}
		function test()
		{
			alert("I am calling..");
								...
								<tr>
									<td>
										<div class="col-md-2 col-sm-2 col-xs-2" >
											<img src="{{ asset('newlog/images/Logo168.png') }}"/>
										</div>
									</td>
