        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="post" action="{{ url('generateTransactionpinFrontEnd') }}" onSubmit="return ConfirmMessage()">
                        {{ csrf_field() }}

                        <input type="hidden" name="token" value="{{ $token }}">
                        
                        <input type="hidden" class="form-control" name="front_verification" id="front_verification" value="1" />
                        <input type="hidden" name="ver_user_id" id="ver_user_id" value="{{@$user_id}}" />
